...
using EdgeProperties = property < edge_index_t, int, property < edge_weight_t, int, property<edge_capacity_t, int > > >;
...
using EdgeFSCMap = property_map<Graph, edge_capacity_t>::type;
